...
def main():
    runs = {r["run"]: r for r in json.loads((HERE / "runs.json").read_text())}
    variants = {
    ...
    fig.savefig(HERE / "converter_port_intervention.png", dpi=170)
    (HERE / "converter_port_analysis.json").write_text(
